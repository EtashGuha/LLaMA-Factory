...
if __name__ == '__main__':
    ...
    metadata_dict = dict()
    ds = load_dataset('jlli/Hungarian_CCPDF_SynQA', cache_dir='/import/ml-sc-scratch3/jonathanl/cache')
    state = np.random.RandomState(seed=SEED)
    for split in ['train', 'test', 'val']:
        img_root = DATAROOT / 'jonathanl_hudocvqa_12_16_2024' / split
        ...
        with open(DATAROOT / f'jonathanl_hudocvqa_12_16_2024_{split}.json', 'w') as f:
